class Bonspiels::Scoreboard::IndexPage < ScoreboardLayout
  ...
  def content
    div class: "flex text-center" do
      div class: "btn-group flex-1 flex" do
        ...
        div game.team_a_score.to_s, class: "btn md:btn-lg lg:btn-xl btn-error animate-none"
      end
      div "#{ordinal(game.current_end)} End", class: "btn md:btn-lg lg:btn-xl animate-none"
      div class: "btn-group flex-1 flex" do
        div game.team_b_score.to_s, class: "btn md:btn-lg lg:btn-xl btn-warning animate-none"
        div game.team_b_name.to_s, class: "flex-1 btn md:btn-lg lg:btn-xl animate-none"
  ...
  private def hammer_button
    div class: "btn md:btn-lg lg:btn-xl fill-white animate-none" do
