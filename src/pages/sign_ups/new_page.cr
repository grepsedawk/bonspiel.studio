  ...
  private def render_form(op)
    form_for SignUps::Create do
      div class: "space-y-6" do
        mount Shared::Field, op.email, "Email", &.email_input(autofocus: "true", append_class: "w-full")
        mount Shared::Field, op.password, "Password", &.password_input(append_class: "w-full")
        mount Shared::Field, op.password_confirmation, "Confirm Password", &.password_input(append_class: "w-full")
      end
